...
cgpenwid(25); cgdraw(-200, -200, 200, 200);
cgpenwid(15); cgdraw(-200, 200, 200, -200);
cgpenwid(10); cgdraw(0, -200, 0, 200);
cgpenwid(5); cgdraw(-200, 0, 200, 0);
...
cgpenwid(5); cgdraw(-200, -200, 200, 200);
cgpenwid(25); cgdraw(-200, 200, 200, -200);
cgpenwid(15); cgdraw(0, -200, 0, 200);
cgpenwid(10); cgdraw(-200, 0, 200, 0);
...
cgpenwid(10); cgdraw(-200, -200, 200, 200);
cgpenwid(5); cgdraw(-200, 200, 200, -200);
cgpenwid(25); cgdraw(0, -200, 0, 200);
cgpenwid(15); cgdraw(-200, 0, 200, 0);
...
cgpenwid(15); cgdraw(-200, -200, 200, 200);
cgpenwid(10); cgdraw(-200, 200, 200, -200);
cgpenwid(5); cgdraw(0, -200, 0, 200);
cgpenwid(25); cgdraw(-200, 0, 200, 0);
